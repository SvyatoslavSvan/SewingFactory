...
namespace SewingFactory.Backend.WorkshopManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250520183351_TimesheetEmployeeManyToMany")]
    partial class TimesheetEmployeeManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeWorkshopDocument", b =>
                {
                    ...
                    b.ToTable("EmployeeWorkshopDocument");
                });
            ...
            modelBuilder.Entity("RateBasedEmployeeTimesheet", b =>
                {
                    b.Property<Guid>("EmployeesId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RateBasedEmployeeTimesheet");
                });

            modelBuilder.Entity("SewingFactory.Backend.WorkshopManagement.Domain.Entities.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SewingFactory.Backend.WorkshopManagement.Domain.Entities.Employees.Base.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SewingFactory.Backend.WorkshopManagement.Domain.Entities.Employees.ProcessBasedEmployee", b =>
                {
                    b.HasBaseType("SewingFactory.Backend.WorkshopManagement.Domain.Entities.Employees.Base.Employee");
            ...
            modelBuilder.Entity("EmployeeWorkshopDocument", b =>
                {
                    ...
                    b.HasOne("SewingFactory.Backend.WorkshopManagement.Domain.Entities.Employees.Base.Employee", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SewingFactory.Backend.WorkshopManagement.Domain.Entities.DocumentItems.EmployeeTaskRepeat", b =>
                {
                    b.HasOne("SewingFactory.Backend.WorkshopManagement.Domain.Entities.Employees.Base.Employee", "WorkShopEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("SewingFactory.Backend.WorkshopManagement.Domain.Entities.DocumentItems.Process", b =>
                {
                    b.HasOne("SewingFactory.Backend.WorkshopManagement.Domain.Entities.Department", "Department")
                        .WithMany("Processes")
