...
public class SwaggerDefinition : AppDefinition
{
    ...
    public override void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            options.SwaggerDoc("v1", new OpenApiInfo { Title = AppData.ServiceName, Version = _appVersion, Description = AppData.ServiceDescription });
            ...
            {
                {
                    new OpenApiSecurityScheme
                    {
                        Reference = new OpenApiReference { Type = ReferenceType.SecurityScheme, Id = "oauth2" }, Scheme = "oauth2", Name = "Bearer", In = ParameterLocation.Header
                    },
                    new List<string>()
                }
            });
