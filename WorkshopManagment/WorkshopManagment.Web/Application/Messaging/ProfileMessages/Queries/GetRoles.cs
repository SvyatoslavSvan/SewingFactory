...
namespace SewingFactory.Backend.WorkshopManagement.Web.Application.Messaging.ProfileMessages.Queries;
...
public sealed class GetProfile
{
        ...
        : IRequestHandler<Request, string>
    {
        public Task<string> Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            var claims = user.FindAll(match: x => x.Type == ClaimTypes.Role);
