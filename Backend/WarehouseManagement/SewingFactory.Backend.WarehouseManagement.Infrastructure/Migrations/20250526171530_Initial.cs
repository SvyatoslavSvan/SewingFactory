        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Operations_PointsOfSale_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "PointsOfSale",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Operations_PointsOfSale_ReceiverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockItems_GarmentModels_GarmentModelId",
                        column: x => x.GarmentModelId,
                        principalTable: "GarmentModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockItems_PointsOfSale_PointOfSaleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockItems_GarmentModelId",
                table: "StockItems",
                column: "GarmentModelId");

            migrationBuilder.CreateIndex(
                name: "IX_StockItems_PointOfSaleId",
                table: "StockItems",
