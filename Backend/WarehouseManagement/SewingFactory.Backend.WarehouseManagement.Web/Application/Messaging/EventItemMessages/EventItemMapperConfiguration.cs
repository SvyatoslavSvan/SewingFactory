...
using SewingFactory.Backend.WarehouseManagement.Web.Definitions.Mapping;

namespace SewingFactory.Backend.WarehouseManagement.Web.Application.Messaging.EventItemMessages
{
    /// <summary>
