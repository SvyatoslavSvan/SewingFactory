...
using SewingFactory.Backend.WarehouseManagement.Web.Application.Messaging.ProfileMessages.ViewModels;
using System.Security.Claims;

namespace SewingFactory.Backend.WarehouseManagement.Web.Application.Messaging.ProfileMessages
{
    /// <summary>
