...
namespace SewingFactory.Backend.WarehouseManagement.Tests.Features.PointOfSale.Domain;
...
public sealed class PointOfSaleTests
{
    ...
    public void Transfer_Nonexistent_Model_Throws()
    {
        ...
        var fakeCategory = new WarehouseManagement.Domain.Entities.Garment.GarmentCategory("Fake", []);
        var fakeModel = new WarehouseManagement.Domain.Entities.Garment.GarmentModel("Fake Tee", fakeCategory, Money.Zero);
