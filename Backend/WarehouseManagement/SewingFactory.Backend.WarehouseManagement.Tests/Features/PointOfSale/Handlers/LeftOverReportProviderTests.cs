...
public sealed class LeftoverReportProviderTests
{
    ...
    private static WarehouseManagement.Domain.Entities.Inventory.PointOfSale CreatePointOfSale()
    {
        var pants = new WarehouseManagement.Domain.Entities.Garment.GarmentCategory("Pants", []);
        var winterPants = new WarehouseManagement.Domain.Entities.Garment.GarmentModel("Winter Pants", pants, new Money(1_200m));
        var summerPants = new WarehouseManagement.Domain.Entities.Garment.GarmentModel("Summer Pants", pants, new Money(900m));

        var shirts = new WarehouseManagement.Domain.Entities.Garment.GarmentCategory("Shirts", []);
        var linenShirt = new WarehouseManagement.Domain.Entities.Garment.GarmentModel("Linen Shirt", shirts, new Money(750m));
