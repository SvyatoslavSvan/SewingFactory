...
public sealed class AllOperationForPointOfSaleReportProviderTests
{
    ...
    private static (WarehouseManagement.Domain.Entities.Inventory.PointOfSale pos, DateRange range, decimal inc, decimal outc) Arrange()
    {
        var cat = new WarehouseManagement.Domain.Entities.Garment.GarmentCategory("Футболки", []);
        var model = new WarehouseManagement.Domain.Entities.Garment.GarmentModel("F-100", cat, Uah(250));
