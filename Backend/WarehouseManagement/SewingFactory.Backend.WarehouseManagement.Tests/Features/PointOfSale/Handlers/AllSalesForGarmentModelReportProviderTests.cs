...
public sealed class AllSalesForGarmentModelReportProviderTests
{
    ...
    private static (WarehouseManagement.Domain.Entities.Garment.GarmentModel model,
        WarehouseManagement.Domain.Entities.Inventory.PointOfSale pos1, WarehouseManagement.Domain.Entities.Inventory.PointOfSale pos2,
        ...
        decimal pos1Sum, decimal pos2Sum) Arrange()
    {
        ...
        var model = new WarehouseManagement.Domain.Entities.Garment.GarmentModel("F-100", cat, Amount(150));

        var pos1 = new WarehouseManagement.Domain.Entities.Inventory.PointOfSale("ТТ-1");
        var pos2 = new WarehouseManagement.Domain.Entities.Inventory.PointOfSale("ТТ-2");
