...
public sealed class DepartmentHandlersTests
{
    ...
    {
        var departments = new List<Department> { new("Cutting Department"), new("Sewing Department"), new("Quality Control") };
    ...
    public async Task GetAllDepartmentsHandler_Should_Return_All_Departments()
    {
        ...
        Assert.Contains(result.Result!, filter: d => d.Name == "Cutting Department");
        Assert.Contains(result.Result!, filter: d => d.Name == "Sewing Department");
        Assert.Contains(result.Result!, filter: d => d.Name == "Quality Control");
    }
    ...
    public async Task UpdateDepartmentHandler_Should_Update_Department()
    {
        ...
        var updateViewModel = new UpdateDepartmentViewModel { Id = existingDepartment.Id, Name = "Updated Cutting Department" };
    ...
    public async Task DeleteDepartmentHandler_Should_Delete_Department()
    {
        ...
        var remainingDepartments = repository.GetAll(TrackingType.NoTracking);
