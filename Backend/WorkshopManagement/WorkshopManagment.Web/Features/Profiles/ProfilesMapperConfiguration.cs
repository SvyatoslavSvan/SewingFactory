...
using SewingFactory.Backend.WorkshopManagement.Web.Features.Profiles.ViewModels;
using System.Security.Claims;

namespace SewingFactory.Backend.WorkshopManagement.Web.Features.Profiles;
