...
using SewingFactory.Backend.IdentityServer.Web.Application.Messaging.EventItemMessages.Queries;

namespace SewingFactory.Backend.IdentityServer.Web.Application.Messaging.EventItemMessages
{
    /// <summary>
