...
using SewingFactory.Backend.WarehouseManagment.Web.Definitions.OpenIddict;
using SewingFactory.Common.Domain.Base;
using System.Text.Json;

namespace SewingFactory.Backend.WarehouseManagment.Web.Definitions.Authorizations
{
    /// <summary>
