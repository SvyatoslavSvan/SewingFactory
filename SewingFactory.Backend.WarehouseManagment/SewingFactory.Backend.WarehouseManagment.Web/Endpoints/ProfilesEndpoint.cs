...
using SewingFactory.Backend.WarehouseManagment.Web.Application.Messaging.ProfileMessages.Queries;
using SewingFactory.Backend.WarehouseManagment.Web.Definitions.Authorizations;

namespace SewingFactory.Backend.WarehouseManagment.Web.Endpoints
{
