...
namespace IdentityServer.Infrastructure.DatabaseInitialization;
...
public static class DatabaseInitializer
{
    ...
    public static async void SeedUsers(IServiceProvider serviceProvider)
    {
        ...
        var developer1 = new ApplicationUser
        {
            ...
            PhoneNumber = "+389000000000",
            EmailConfirmed = true,
            PhoneNumberConfirmed = true,
            SecurityStamp = Guid.NewGuid().ToString("D"),
            ApplicationUserProfile = new ApplicationUserProfile(DateTime.Now,
                "SEED",
                null,
                [
                    new AppPermission(DateTime.Now,
                        "SEED",
                        Guid.Empty,
                        null,
                        "Profiles:Roles:Get",
                        "Access policy for view Roles in user Profiles")
                ])
        };
