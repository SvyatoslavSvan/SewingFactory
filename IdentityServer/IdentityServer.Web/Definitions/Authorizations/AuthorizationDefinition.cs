...
using IdentityServer.Web.Definitions.OpenIddict;
...
namespace IdentityServer.Web.Definitions.Authorizations;
...
public class AuthorizationDefinition : AppDefinition
{
    ...
    public override void ConfigureServices(WebApplicationBuilder builder)
    {
        builder.Services
            ...
            .AddCookie(CookieAuthenticationDefaults.AuthenticationScheme, configureOptions: options =>
            {
                options.LoginPath = "/connect/login";
            })
            .AddJwtBearer(JwtBearerDefaults.AuthenticationScheme, "Bearer", configureOptions: options =>
            {
        ...
        {
            options.AddPolicy(AppData.PolicyDefaultName, configurePolicy: x =>
            {
